...
saveRDS(lemmas, file="lemmas.rds")
...
topics<- LDA(Lemmas, 
             k=15, 
             method = "Gibbs", 
             control = list(burnin = 2000, iter = 5000, keep = 50, verbose=1))
...
saveRDS(topics, file="BOW_topics.rds") 
saveRDS(model.L, file="BOW_glmmodel.rds") 
saveRDS(Class, file="BOW_classes.rds") 
saveRDS(Lemmas, file="BOW_Lemmas_matrix.rds")
saveRDS(lemmas, file="BOW_lemmas.rds") 
